...
public static class ToolRegistry
{
    ...
    private static void AddSystemTools() => _allTools!.AddRange(new List<ToolItem>
    {
        ...
        new() { Name = "Bandizip", Category = "系统工具",
            Description = "轻量快速的文件压缩/解压工具，支持多种格式",
            OfficialUrl = "https://www.bandisoft.com/bandizip/",
            WingetId = "Bandisoft.Bandizip", RiskLevel = "推荐" },
        new() { Name = "NanaZip", Category = "系统工具",
            Description = "基于7-Zip的开源压缩工具，适配Win11现代UI",
            GithubUrl = "https://github.com/M2Team/NanaZip",
            WingetId = "M2Team.NanaZip", RiskLevel = "推荐" },
        new() { Name = "BCUninstaller", Category = "系统工具",
            Description = "开源批量软件卸载工具，支持强制卸载和残留清理",
            OfficialUrl = "https://www.bcuninstaller.com/",
            WingetId = "Klocman.BulkCrapUninstaller", RiskLevel = "安全" },
        new() { Name = "Mem Reduct", Category = "系统工具",
            Description = "轻量内存清理工具，释放系统内存缓存",
            GithubUrl = "https://github.com/henrypp/memreduct",
            WingetId = "Henry++.MemReduct", RiskLevel = "安全" },
        new() { Name = "PrivaZer", Category = "系统工具",
            Description = "深度隐私清理工具，擦除上网痕迹和使用记录",
            OfficialUrl = "https://privazer.com/",
            WingetId = "Goversoft.PrivaZer", RiskLevel = "安全" },
        new() { Name = "CleanMyWeChat", Category = "系统工具",
            Description = "微信缓存清理工具，释放微信占用的磁盘空间",
            GithubUrl = "https://github.com/blackboxo/CleanMyWeChat", RiskLevel = "安全" },
        new() { Name = "PDFgear", Category = "系统工具",
            Description = "免费PDF编辑工具，支持阅读/编辑/转换/合并/签名",
            OfficialUrl = "https://www.pdfgear.com/",
            WingetId = "PDFgear.PDFgear", RiskLevel = "推荐" },
        new() { Name = "AB Download Manager", Category = "系统工具",
            Description = "开源下载管理器，支持多线程下载/视频嗅探",
            GithubUrl = "https://github.com/amir1376/ab-download-manager",
            WingetId = "amir1376.ABDownloadManager", RiskLevel = "安全" },
    });
    ...
    private static void AddDesignTools() => _allTools!.AddRange(new List<ToolItem>
    {
        ...
        new() { Name = "Darktable", Category = "图像与设计工具",
            Description = "开源RAW图像处理软件，摄影后期处理工作流工具",
            OfficialUrl = "https://www.darktable.org/",
            WingetId = "darktable.darktable", RiskLevel = "推荐" }
    });
